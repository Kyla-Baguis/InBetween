"""
JUPITER - Blender 5.1 compatible
...
def build_jupiter():
    reset()
    set_black_world()
    p = sphere("Jupiter", 1.0)
    p.scale.z = 0.935
    p.data.materials.append(
        mat_diffuse("Jupiter_Mat", "jupiter.jpg", 0.7, (0.85, 0.7, 0.55, 1)))
    add_spin(p, 3.1, 150)
    l = make_light(energy=3.5, loc=(-5, 8, 5), color=(1, 0.97, 0.9), ltype='SUN')
