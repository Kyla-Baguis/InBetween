"""
NEPTUNE - Blender 5.1 compatible
...
def build_neptune():
    reset()
    set_black_world()
    p = sphere("Neptune", 1.0)
    p.data.materials.append(
        mat_diffuse("Neptune_Mat", "neptune.jpg", 0.4, (0.1, 0.2, 0.9, 1)))
    add_spin(p, 28.3, FRAMES)
    a = atmo_sphere("Neptune_Atmo", 1.06)
    a.data.materials.append(mat_atmo("Neptune_AtmoMat", (0.05, 0.2, 0.95, 1), 0.4))
    l = make_light(energy=2.0, loc=(-5, 8, 5), color=(0.9, 0.95, 1.0), ltype='SUN')
